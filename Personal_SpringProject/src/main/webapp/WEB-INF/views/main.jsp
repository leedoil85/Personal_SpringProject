...
<nav class="navbar navbar-default navbar-expand-xl navbar-primary">
	...
	<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
		<ul class="nav navbar-nav">
			...
			<li class="nav-item"><a href="#" class="nav-link">Contactrp</a></li>
		</ul>
		...
		<ul class="nav navbar-nav navbar-right ml-auto">
			...
			<li class="nav-item dropdown">
				<!-- 프로필 기본 사진 설정 src에 이미지 경로 db에 이미지경로 들어갈 컬럼 추가요망 19-04-08 -->
				<a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle user-action"><img src="https://www.tutorialrepublic.com/examples/images/avatar/2.jpg" class="avatar" alt="Avatar"> ${mem_id} <b class="caret"></b></a>
				<ul class="dropdown-menu">
					<li><a href="#" class="dropdown-item"><i class="fa fa-user-o"></i> 내정보</a></li>
					<li><a href="#" class="dropdown-item"><i class="fa fa-calendar-o"></i> 캘린더</a></li>
					<li><a href="#" class="dropdown-item"><i class="fa fa-sliders"></i> 설정</a></li>
					<li class="divider dropdown-divider"></li>
					<li><a href="/myboard/logout.do" class="dropdown-item"><i class="material-icons">&#xE8AC;</i> 로그아웃</a></li>
				</ul>
			</li>
		</ul>
	</div>
